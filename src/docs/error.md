...
```
curl --location --request POST 'https://maisi-ai.com/v1/responses' \
...
```
curl --location --request POST 'https://maisi-ai.com/gemini/v1beta/models/gemini-2.5-flash:streamGenerateContent?alt=sse' \
--header 'Content-Type: application/json' \
